...
class conexion:
    ...
    def buscar_libro_por_isbn(cursor,isbn):
        SQL = '''
    ...
    def insertar_libro(connection,cursor,isbn,titulo,nombre_editorial,anio_libro,nombre_autor):
    ...
    def actualizar_titulo(connection,cursor,nombre_libro,buscar_isbn):
    ...
    def eliminar_libro(connection,cursor,eliminar_libro):
